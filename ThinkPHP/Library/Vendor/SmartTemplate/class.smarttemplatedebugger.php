	...
	class SmartTemplateDebugger
	{
		...
		*/
		function start ( $vars )
		{
			...
			echo '<li><a href="#data_code">ErrorNum</a></li>';
			echo '</b></font><hr>';
			...
			// Print ErrorNum
			echo '<a name="data_code"><br><br><font face="Arial" Size="3"><b>ErrorNum:</b>&nbsp;[<a href="javascript:void(\'\');" onclick="toggleVisibility(document.getElementById(ErErrorNumum), this); return false">Hide Ouptut</a>]</font><br>';
			echo '<table border="0" cellpadding="4" cellspacing="1" width="100%" bgcolor="#C6D3EF"><tr><td bgcolor="#F0F0F0"><pre id="ErrorNum" style="display:block">';
